...
`;
        ...
        await Promise.all(assetKeys.map(async (key) => {
            ...
            try {
                ...
                // FIX: Added a null check for response.Body to prevent a build error
                if (response.Body) {
