...
const StagingBanner: React.FC<StagingBannerProps> = ({ onExit }) => {
  return (
    <div className="bg-yellow-500 text-black text-center py-1.5 px-4 fixed top-0 w-full z-[100] h-8 flex items-center justify-center text-sm">
