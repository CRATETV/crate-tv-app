...
const AnalyticsPage: React.FC<AnalyticsPageProps> = ({ viewMode }) => {
    ...
    // Explicitly cast properties to Number before performing arithmetic operations to prevent TypeScript errors.
                    ...
                    {(activeTab === 'overview' && !isFestivalView) && (
                        <div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                                {/* Explicitly cast to Number before passing to functions. */}
                                ...
                                {/* Explicitly cast the value from `Object.values` to a number inside the `reduce` function to prevent type errors. */}
                        ...
                        <div className="space-y-10">
                             <div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                                    ...
                                    {/* Explicitly cast properties to Number before addition. */}
