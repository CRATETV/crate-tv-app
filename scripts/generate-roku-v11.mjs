...
// 5. SIDEBAR (Auto-Expanding on Focus)
...
<component name="SideBar" extends="Group">
    ...
    <children>
        ...
        <Animation id="expandAnim" duration="0.2" easeFunction="outCubic">
            ...
            <FloatInterpolator key="[0.0, 1.0]" keyValue="[ 100.0, 350.0 ]" fieldToInterp="bg.width" />
        </Animation>
        <Animation id="collapseAnim" duration="0.2" easeFunction="outCubic">
            ...
            <FloatInterpolator key="[0.0, 1.0]" keyValue="[ 350.0, 100.0 ]" fieldToInterp="bg.width" />
        </Animation>
    </children>
</component>
`);
...
sub init()
    ...
    ' Observe own focus to trigger animation
...
sub onFocusChange()
    if m.top.hasFocus()
        ...
        ' Ensure one button has focus (default to Home if none)
...
<component name="MainScene" extends="Scene">
    ...
    <children>
        ...
        <!-- View Container (Pushed right to sit next to sidebar) -->
        <Group id="viewContainer" translation="[100, 0]" />
        
        <!-- Sidebar (Always visible on top) -->
        <SideBar id="sideBar" />
...
sub onNavSelect(evt)
    ...
    ' Return focus to the new view immediately
...
sub onMovieSelected(evt)
    ...
    m.top.appendChild(details) ' Add to TOP to cover sidebar
...
// 7. HOME VIEW (Fixing Focus Traps)
...
function onKeyEvent(key, press)
    if press
        if key = "left"
            ' If user is on the far left column, give focus back to sidebar
    ...
    <children>
        ...
        <Group translation="[100, 150]">
            ...
            <Group translation="[350, 0]">
                ...
                <!-- Play Button -->
                <Group id="playBtnGroup" translation="[0, 400]">
                     <Rectangle id="playBtnBg" width="300" height="80" color="#E50914" cornerRadius="5" />
                     ...
                     <Rectangle id="playBtnFocus" width="310" height="90" translation="[-5,-5]" color="#FFFFFF" fill="false" opacity="0" stroke="4" />
                </Group>
            </Group>
        </Group>
...
sub init()
    ...
    ' Start with play button focused visually
    m.playBtnFocus.opacity = 1
end sub
    ...
    if press
        if key = "OK" or key = "play"
            ...
            if m.video.visible
                ...
                ' Force MainScene to restore focus to viewContainer
...
console.log("---------------------------------------------------");
console.log("✅ ROKU V11 (FUNCTIONAL NAVIGATION) GENERATED");
