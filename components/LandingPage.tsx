            ...
            <main className="flex-grow">
                {heroMovies.length > 0 && (
                    <Hero
                        ...
                        onSelectMovie={() => handleNavigate('/login')}
                    />
                )}
                    ...
                    {aboutData && (
                        <>
                            ...
                            <section className="text-center py-16 md:py-20 bg-gray-900">
                                ...
                                <button onClick={() => handleNavigate('/login?view=signup')} className="bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-8 rounded-lg text-lg transition-transform hover:scale-105">
                                    Get Started
                                </button>
                            </section>
                        </>
