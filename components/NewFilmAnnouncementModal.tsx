import { cardImage, modalImage } from '../services/imageUrl';
...
const NewFilmAnnouncementModal: React.FC<NewFilmAnnouncementModalProps> = ({ movie, onClose, onWatchNow }) => {
  ...
  return (
    ...
    >
      ...
      >
        <img src={modalImage(movie.poster)} alt="" className="absolute inset-0 w-full h-full object-cover opacity-20 blur-sm" crossOrigin="anonymous" loading="lazy"/>
        ...
        <div className="relative z-10 p-8 flex flex-col items-center text-center">
            ...
            <img src={modalImage(movie.poster)} alt={movie.title} className="w-48 h-auto rounded-md shadow-lg my-4 border-2 border-gray-600" crossOrigin="anonymous" loading="lazy"/>
