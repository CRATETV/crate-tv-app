    ...
    return (
        ...
        >
            ...
            >
                ...
                <button onClick={onMoreDetails} className="text-sm bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white font-bold py-2 px-6 rounded-lg transition-colors">
                    More Info
                </button>
            </div>
        </div>
