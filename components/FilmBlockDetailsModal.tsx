        ...
        >
            ...
            >
                ...
                <div className="p-8">
                    ...
                    <div 
                      className="mb-6 bg-teal-500 hover:bg-teal-600 text-white font-bold py-3 px-6 rounded-lg transition-transform hover:scale-105 cursor-pointer shadow-md text-center"
                    ...
                    <div className="space-y-4">
                        {blockMovies.map(movie => (
                            <div key={movie.key} className="flex items-center gap-4 bg-gray-800/50 p-3 rounded-lg">
                                ...
                                <div 
                                    className="flex-shrink-0 bg-gray-700 hover:bg-gray-600 text-gray-200 font-bold py-2 px-4 rounded-lg transition-colors cursor-pointer text-sm"
                                    onClick={handlePurchaseClick}
                                >
                                    Unlock - $5.00
                                </div>
