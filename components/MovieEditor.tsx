    ...
    useEffect(() => {
        if (movieToCreate) {
            ...
            setFormData({
                ...
                fullMovie: movieToCreate.fullMovie || movieToCreate.movieUrl || '',
                poster: movieToCreate.poster || movieToCreate.posterUrl || '',
                tvPoster: movieToCreate.poster || movieToCreate.posterUrl || '',
                isSupportEnabled: true,
