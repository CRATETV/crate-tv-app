...
const CATEGORIES = [
    { id: 'philly_open', label: 'Community Shows (Local)', icon: '🏘️' },
    { id: 'open_master', label: 'Open Studio (Home Page)', icon: '💎' },
    { id: 'modern_short', label: 'Vimeo CC-BY (2024+)', icon: '🎬' },
...
const ArchiveScoutTab: React.FC = () => {
    ...
    const [activeFilter, setActiveFilter] = useState('philly_open');
        ...
        <div className="flex flex-col gap-8 animate-[fadeIn_0.5s_ease-out] pb-24">
            <div className="flex justify-center mb-4">
                <div className="bg-black border border-white/5 p-1 rounded-2xl inline-flex shadow-2xl">
                    <button onClick={() => setView('scout')} className={`px-8 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${view === 'scout' ? 'bg-cyan-600 text-white shadow-lg' : 'text-gray-500 hover:text-white'}`}>Archive Scout</button>
                    ...
                    <div className="w-full xl:w-[450px] space-y-8 flex-shrink-0">
                        <div className="bg-cyan-600/10 border border-cyan-500/20 p-8 rounded-[3rem] shadow-xl relative overflow-hidden">
                            <div className="relative z-10">
                                ...
                                <p className="text-gray-400 font-medium leading-relaxed mb-10 text-sm">Identifying Creative Commons cinema and <span className="text-white font-bold">local community records</span> suitable for Crate TV distribution.</p>
                                    ...
                                    <div key={i} className="bg-[#0f0f0f] border border-white/5 p-10 rounded-[3.5rem] flex flex-col justify-between group hover:border-cyan-500/40 transition-all shadow-2xl relative overflow-hidden h-full">
                                        <div className="space-y-8 relative z-10">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-gray-500 text-[11px] font-bold mt-3 uppercase tracking-[0.2em]">Source: {f.director}</p>
                                            </div>
                                        ...
                                        <div className="mt-12 pt-8 border-t border-white/5 flex flex-col gap-3 relative z-10">
                                            <button 
                                                ...
                                                className="bg-red-600 text-white font-black py-5 rounded-2xl uppercase text-[11px] tracking-widest text-center shadow-xl hover:bg-red-500 transition-all active:scale-95 flex items-center justify-center gap-3"
                                            >
                                                {ingestingId === i ? 'Routing...' : 'Route to Grand Jury'}
