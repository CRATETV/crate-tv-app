...
const StrategicHub: React.FC<StrategicHubProps> = ({ analytics }) => {
    ...
    return (
        <div className="space-y-16 animate-[fadeIn_0.5s_ease-out] pb-32">
            ...
            {/* VOUCHER OPS: TURN APPLAUSE INTO ACTION */}
            <div className="bg-gradient-to-br from-green-900/20 to-black border border-green-500/20 p-10 rounded-[3rem] shadow-2xl space-y-10 relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <div className="mb-10">
                        ...
                        <p className="text-gray-400 max-w-2xl mt-4 font-medium leading-relaxed">Respond to social media praise with immediate value. Issue single-use master keys to turn "likes" into "streams".</p>
                    </div>
                    ...
                    <div className="relative z-10 space-y-8">
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                            <div>
                                ...
                                <p className="text-gray-400 font-medium leading-relaxed mt-2">Synthesize high-stakes copy to STOP THE SCROLL on social platforms.</p>
                            </div>
                        ...
                        >
                            {isSynthesizing ? 'Consulting Gemini Core...' : 'Synthesize Conversion Manifest'}
                        </button>
                    </div>
                </div>
            ...
            {manifest && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 animate-[fadeIn_0.8s_ease-out]">
                    <div className="space-y-6">
                        <ManifestBlock label="Viral Headline / Hook" text={manifest.tagline} />
                        <ManifestBlock label="Short Action Pitch (160 Chars)" text={manifest.shortDesc} />
                        <ManifestBlock label="The Scarcity Statement" text={manifest.problem} />
                    </div>
                    <div className="space-y-6">
                        <ManifestBlock label="The Value Proposition" text={manifest.solution} />
                        <ManifestBlock label="Closing CTA" text={manifest.impact} />
                        <div className="bg-indigo-600/10 border border-indigo-500/20 p-8 rounded-3xl space-y-4">
                            <h4 className="text-[10px] font-black text-indigo-400 uppercase tracking-widest">Strategy Note</h4>
                            <p className="text-gray-400 text-xs leading-relaxed italic">Use the Scarcity Statement in replies to commenters. Frame the free voucher as an exclusive invitation to the inner circle.</p>
                        </div>
                    </div>
                </div>
            )}
