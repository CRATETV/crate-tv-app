...
const FestivalLiveCarousel: React.FC<FestivalLiveCarouselProps> = ({ allMovies, allCategories, onSelectMovie, watchedMovies, watchlist, likedMovies, onToggleLike, onToggleWatchlist, onSupportMovie }) => {
