                ...
                {messages.map(msg => (
                    <div key={msg.id} className="flex items-start gap-3 group">
                        ...
                        <button
                            ...
                            className="flex-shrink-0 flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider text-gray-400 hover:text-red-500 focus:text-red-500 transition-colors p-1 disabled:opacity-50"
                        >
