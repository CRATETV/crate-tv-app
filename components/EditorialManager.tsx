...
import { EditorialStory, Movie, FilmBlock } from '../types';
        ...
        <div className="space-y-10 animate-[fadeIn_0.5s_ease-out] pb-32">
            <div className="flex justify-between items-center border-b border-white/5 pb-8">
                <div>
                    ...
                    <p className="text-gray-500 text-[10px] font-black uppercase tracking-[0.4em] mt-1">Editorial Interface V4.1</p>
                </div>
                <div className="flex gap-4">
                    <button onClick={() => { setSelectedStory(null); setFormData(emptyStory); }} className="bg-white/5 text-gray-500 px-6 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest border border-white/10">Reset Terminal</button>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="bg-[#0f0f0f] border border-white/5 p-12 rounded-[3.5rem] shadow-2xl space-y-10">
                        <div className="space-y-6">
                            <input 
                                ...
                                className="w-full bg-transparent text-5xl font-black uppercase tracking-tighter text-white focus:outline-none placeholder:text-gray-900 border-b border-white/5 pb-4"
                            />
                            <input 
                                value={formData.subtitle} 
                                onChange={e => setFormData({...formData, subtitle: e.target.value})}
                                placeholder="Sub-narrative or editorial hook..." 
                                className="w-full bg-transparent text-xl font-bold text-gray-600 focus:outline-none placeholder:text-gray-900"
                            />
                        </div>
                        ...
                        <div className="aspect-video bg-black rounded-[2rem] overflow-hidden border border-white/5 relative group shadow-inner">
                            {formData.heroImage ? (
                                ...
                                <div className="h-full flex items-center justify-center text-[10px] text-gray-800 font-black uppercase tracking-[0.4em]">Awaiting Visual Payload</div>
                            )}
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-center text-[9px] font-black text-gray-600 uppercase tracking-widest px-2">
                                <span>Narrative Payload (HTML Compatible)</span>
                                <span>Rich Text Engine Ready</span>
                            </div>
                            <textarea 
                ...
                <div className="space-y-8">
                    <div className="bg-[#0f0f0f] border border-white/5 p-8 rounded-[3rem] space-y-8 shadow-2xl">
                        <h3 className="text-sm font-black text-red-500 uppercase tracking-[0.3em]">Binding Controls</h3>
                        
                        <div className="space-y-6">
                            <div>
                                <label className="text-[10px] font-black text-gray-600 uppercase mb-2 block">Story Type</label>
                            ...
                            <div>
                                <label className="text-[10px] font-black text-gray-600 uppercase mb-2 block">Link Target Film</label>
                    ...
                    <div className="bg-black/40 border border-white/5 p-8 rounded-[3rem] shadow-2xl">
                        <h3 className="text-[10px] font-black text-gray-700 uppercase tracking-widest mb-6">Archive Feed</h3>
