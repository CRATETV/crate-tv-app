import { modalImage } from '../services/imageUrl';
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 p-8 flex flex-col items-center text-center">
            ...
            <img src={modalImage(movie.poster)} alt={movie.title} className="w-40 h-auto rounded-md shadow-lg my-4 border-2 border-gray-600" crossOrigin="anonymous" loading="lazy"/>
