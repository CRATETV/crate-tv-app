          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
              <ul className="flex flex-wrap items-center justify-center gap-x-6 sm:gap-x-8 gap-y-4 text-sm">
                <li>
                 ...
                 <li>
                  <a href="/top-ten" onClick={(e) => handleNavigate(e, '/top-ten')} className="hover:text-white transition">Top 10 Films</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/filmmaker-signup" onClick={(e) => handleNavigate(e, '/filmmaker-signup')} className="hover:text-white transition">Filmmaker Dashboard</a>
                </li>
                <li>
