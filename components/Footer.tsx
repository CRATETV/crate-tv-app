    ...
    <footer className="bg-black text-gray-400 py-12 px-4 md:px-12 mt-12 border-t border-white/5">
      <div className="max-w-7xl mx-auto">
        <div className={`grid grid-cols-2 md:grid-cols-4 gap-8 mb-8`}>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/shop" onClick={(e) => handleNavigate(e, '/shop')} className="hover:text-white transition">Shop</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/submit" onClick={(e) => handleNavigate(e, '/submit')} className="hover:text-amber-400 transition font-black text-amber-500 uppercase tracking-widest text-[10px]">Submit Your Film</a></li>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-sm mt-8">
          ...
          <p className="text-gray-600 text-[10px] uppercase tracking-[0.3em] mt-1">Television powered by creatives</p>
        </div>
      </div>
    </footer>
  );
