...
const CratemasPage: React.FC = () => {
    ...
    const cratemasMovies = useMemo(() => {
        const cratemasCategory = categories.cratemas;
        if (!cratemasCategory) return [];
            ...
            <main className="flex-grow pb-24 md:pb-0 relative z-10">
                ...
                <div className="relative py-24 md:py-32 bg-gradient-to-b from-[#064e3b] to-[#042116] overflow-hidden">
                    ...
                    <div className="relative z-10 max-w-4xl mx-auto text-center px-4 animate-[fadeIn_0.8s_ease-out]">
                        <h1 className="text-6xl md:text-8xl font-black italic tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-red-600 via-white to-green-600 mb-6 drop-shadow-[0_0_30px_rgba(255,255,255,0.3)]">
                            Cratemas
                        </h1>
                    ...
                    {cratemasMovies.length > 0 ? (
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 md:gap-8">
                            {cratemasMovies.map(movie => (
                                <div key={movie.key} className="hover:shadow-[0_0_20px_rgba(239,68,68,0.2)] rounded-lg transition-shadow">
                                    <MovieCard 
                                        movie={movie} 
