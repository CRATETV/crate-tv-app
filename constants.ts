...
export const categoriesData: Record<string, Category> = {
  ...
  drama: {
    title: "Drama",
    movieKeys: ['lifeless', 'almasvows', 'finallycaught', 'iloveyoublack', 'autumn', 'silentlove', 'juniper', 'drive', 'crossroads', 'fatherdaughterdance']
  },
  comedy: {
    title: "Comedy",
  ...
  phillyFilmFest2025: {
    title: "New Selections Coming after the 12th Annual PWFF",
