...
export const moviesData: Record<string, Movie> = {
  "atriptothemoon": {
    ...
    "cast": [{ "name": "Georges Méliès", "photo": "https://cratetelevision.s3.us-east-1.amazonaws.com/public+domain+movies+/Me%CC%81lie%CC%80s_portrait_(cropped).png", "bio": "A French illusionist and film director who led many technical and narrative developments in the earliest days of cinema. He was a prolific innovator in the use of special effects, popularizing such techniques as substitution splices, multiple exposures, and time-lapse photography.", "highResPhoto": "https://cratetelevision.s3.us-east-1.amazonaws.com/public+domain+movies+/Me%CC%81lie%CC%80s_portrait_(cropped).png" }],
  ...
  "suspense": {
    ...
    "cast": [
        { "name": "Lois Weber", "photo": "https://cratetelevision.s3.us-east-1.amazonaws.com/public+domain+movies+/LoisWeber.jpg", "bio": "An American silent film actress, screenwriter, producer, and director. She is identified as 'the most important female director the American film industry has known'.", "highResPhoto": "https://cratetelevision.s3.us-east-1.amazonaws.com/public+domain+movies+/LoisWeber.jpg" },
  ...
  "palmourstreet": {
    ...
    "cast": [{ "name": "The Williams Family", "photo": "https://cratetelevision.s3.us-east-1.amazonaws.com/public+domain+movies+/Palmour_Street_2.jpg", "bio": "The film documents the everyday lives of the Williams family in Gainesville, Georgia, offering a poignant and realistic look at family dynamics and child-rearing within a Black community in the segregated South.", "highResPhoto": "https://cratetelevision.s3.us-east-1.amazonaws.com/public+domain+movies+/Palmour_Street_2.jpg" }],
  ...
  "foodiecalldirectorscut": {
    ...
    "poster": "https://cratetelevision.s3.us-east-1.amazonaws.com/Foodie+Call+Directors+cut+poster+.jpg",
  ...
  "foodiecalltheatricalcut": {
    ...
    "poster": "https://cratetelevision.s3.us-east-1.amazonaws.com/Foodie+Call+theatrical+poster.jpg",
    "tvPoster": "https://cratetelevision.s3.us-east-1.amazonaws.com/instant+tv+posters++folder/Foodie+Call.png",
    "likes": 0
  },
  "finallycaught": {
  ...
  "iloveyoublack": {
    ...
    "poster": "https://cratetelevision.s3.us-east-1.amazonaws.com/I+Love+You%2C+Black+Poster.jpg",
  ...
  "hair": {
    "key": "hair",
    "title": "Hair",
    "synopsis": "An African American woman's identity is challenged when she is pressured to straighten her natural hair for a job interview.",
    "cast": [
      {
        "name": "Thatia MomPremier",
        "photo": "https://cratetelevision.s3.us-east-1.amazonaws.com/photos+/Tathia+Mompri_6705.jpg",
    ...
    "poster": "https://cratetelevision.s3.amazonaws.com/hair+poster.png",
  ...
  "autumn": {
    "key": "autumn",
    "title": "Autumn",
    "synopsis": "Synopsis for Autumn. This is placeholder data.",
    "cast": [],
    "director": "Unknown",
    "trailer": "",
    "fullMovie": "",
    "poster": "https://via.placeholder.com/400x533.png?text=Poster+Not+Available",
    "likes": 0
  },
  "silentlove": {
    "key": "silentlove",
    "title": "Silent Love",
    "synopsis": "Synopsis for Silent Love. This is placeholder data.",
    "cast": [],
    "director": "Unknown",
    "trailer": "",
    "fullMovie": "",
  ...
  "juniper": {
    "key": "juniper",
    "title": "Juniper",
    "synopsis": "A self-destructive teenager is suspended from school and sent to live with his grandmother, a former war photographer with a lust for life.",
    "cast": [],
    "director": "Unknown",
    "trailer": "",
    "fullMovie": "",
    "poster": "https://via.placeholder.com/400x533.png?text=Juniper",
    "likes": 0
  },
  "drive": {
    "key": "drive",
    "title": "Drive",
    "synopsis": "Synopsis for Drive. This is placeholder data.",
    "cast": [],
    "director": "Unknown",
    "trailer": "",
    "fullMovie": "",
  ...
  "crossroads": {
    "key": "crossroads",
    "title": "Crossroads",
    "synopsis": "Synopsis for Crossroads. This is placeholder data.",
    "cast": [],
    "director": "Unknown",
    "trailer": "",
    "fullMovie": "",
  ...
  "fatherdaughterdance": {
    ...
    "synopsis": "Synopsis for Father Daughter Dance. This is placeholder data.",
    "cast": [],
    "director": "Unknown",
    "trailer": "",
    "fullMovie": "",
  ...
  "streeteatstheboot": {
    ...
    "synopsis": "Synopsis for Street Eats: The Boot. This is placeholder data.",
    "cast": [],
    "director": "Unknown",
    "trailer": "",
    "fullMovie": "",
  ...
  "smirk": {
    "key": "smirk",
    "title": "Smirk",
    "synopsis": "Synopsis for Smirk. This is placeholder data.",
    "cast": [],
    "director": "Unknown",
    "trailer": "",
    "fullMovie": "",
  ...
  "intrusivethoughts": {
    ...
    "synopsis": "Synopsis for Intrusive Thoughts. This is placeholder data.",
    "cast": [],
    "director": "Unknown",
    "trailer": "",
    "fullMovie": "",
  ...
  "eharmonycs": {
    "key": "eharmonycs",
    "title": "eHarmony CS",
    "synopsis": "Synopsis for eHarmony CS. This is placeholder data.",
    "cast": [],
    "director": "Unknown",
    "trailer": "",
    "fullMovie": "",
  ...
  "youvsthem": {
    "key": "youvsthem",
    "title": "You vs. Them",
    "synopsis": "Synopsis for You vs. Them. This is placeholder data.",
    "cast": [],
    "director": "Unknown",
    "trailer": "",
    "fullMovie": "",
  ...
  "wrapitup": {
    "key": "wrapitup",
    "title": "Wrap It Up",
    "synopsis": "Synopsis for Wrap It Up. This is placeholder data.",
    "cast": [],
    "director": "Unknown",
    "trailer": "",
    "fullMovie": "",
  ...
  "newmovie1756741314485": {
    ...
    "title": "What If",
    "synopsis": "Synopsis for What If. This is placeholder data.",
    "cast": [],
    "director": "Unknown",
    "trailer": "",
    "fullMovie": "",
  ...
  "newmovie1756501125076": {
    ...
    "synopsis": "Synopsis for of Bees and Boobs. This is placeholder data.",
    "cast": [],
    "director": "Unknown",
    "trailer": "",
    "fullMovie": "",
  ...
  "newmovie1756487626529": {
    ...
    "synopsis": "Synopsis for Strange Encounters. This is placeholder data.",
    "cast": [],
    "director": "Unknown",
    "trailer": "",
    "fullMovie": "",
  ...
  "newmovie1756487390550": {
    ...
    "synopsis": "Synopsis for I Still Love Her. This is placeholder data.",
    "cast": [],
    "director": "Unknown",
    "trailer": "",
    "fullMovie": "",
  ...
  "newmovie1756487215116": {
    ...
    "title": "Fling",
    "synopsis": "Synopsis for Fling. This is placeholder data.",
    "cast": [],
    "director": "Unknown",
    "trailer": "",
    "fullMovie": "",
  ...
  "newmovie1756486933392": {
    ...
    "title": "Power Trip",
    "synopsis": "Synopsis for Power Trip. This is placeholder data.",
    "cast": [],
    "director": "Unknown",
    "trailer": "",
    "fullMovie": "",
  ...
  "newmovie1756485973547": {
    ...
    "title": "Burst",
    "synopsis": "Synopsis for Burst. This is placeholder data.",
    "cast": [],
    "director": "Unknown",
    "trailer": "",
    "fullMovie": "",
    ...
    blocks: [
      {
        ...
        movieKeys: ['lifeless', 'almasvows', 'juniper'],
      },
      {
        id: 'day1-block2',
        title: 'Comedic Chaos',
        movieKeys: ['foodiecalldirectorscut', 'eharmonycs', 'wrapitup'],
      },
      {
        id: 'day1-block3',
        title: 'Unsettling Encounters',
        movieKeys: ['newmovie1756487626529', 'smirk'],
      }
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        movieKeys: ['newmovie1756487215116', 'newmovie1756487390550', 'silentlove'],
      },
      {
        id: 'day2-block2',
        title: 'Cycles of Power',
        movieKeys: ['newmovie1756486933392', 'hair', 'iloveyoublack'],
      },
      {
        id: 'day2-block3',
        title: 'Bold Visions',
        movieKeys: ['fatherdaughterdance', 'crossroads', 'drive'],
      }
    ],
  },
  {
    ...
    blocks: [
      {
        id: 'day3-block1',
        title: 'Absurdity & Art',
        movieKeys: ['newmovie1756501125076', 'newmovie1756485973547', 'youvsthem'],
      },
      {
        id: 'day3-block2',
        title: 'The Human Condition',
        movieKeys: ['autumn', 'finallycaught', 'intrusivethoughts'],
      },
       {
        id: 'day3-block3',
        title: 'Spotlight Premiere',
        movieKeys: ['newmovie1756741314485'],
      }
    ],
  },
];